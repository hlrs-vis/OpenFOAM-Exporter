...
namespace BIM.OpenFOAMExport.OpenFOAM
{
    ...
    public class T : FOAMParameter<double>
    {
        ...
        public T(Version version, string path, Dictionary<string, object> attributes, SaveFormat format, Settings settings, string _wallName,
            List<string> _InletNames, List<string> _OutletNames)
            : base(version, path, attributes, format, settings, "T", "volScalarField", _wallName, _InletNames, _OutletNames)
        {
        }
