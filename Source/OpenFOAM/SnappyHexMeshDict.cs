...
namespace BIM.OpenFoamExport.OpenFOAM
{
    ...
    public class SnappyHexMeshDict : FoamDict
    {
        ...
        public override void InitAttributes()
        {
            ...
            FoamFile.Attributes.Add("castellatedMesh", m_Settings.CastellatedMesh);
            FoamFile.Attributes.Add("snap", m_Settings.Snap);
            FoamFile.Attributes.Add("addLayers", m_Settings.AddLayers);
            FoamFile.Attributes.Add("geometry", m_Geometry);
            FoamFile.Attributes.Add("castellatedMeshControls", m_CastellatedMeshControls);
            FoamFile.Attributes.Add("snapControls", m_SnapControls);
            FoamFile.Attributes.Add("addLayersControls", m_AddLayersControls);
            FoamFile.Attributes.Add("meshQualityControls", m_MeshQualityControls);
        ...
        private void InitCastellatedMeshControls()
        {
            ...
            m_CastellatedMeshControls.Add("resolveFeatureAngle", m_Settings.ResolveFeatureAngle);
            m_CastellatedMeshControls.Add("refinementRegions", m_Settings.RefinementRegions);
            m_CastellatedMeshControls.Add("locationInMesh", m_LocationInMesh);
            m_CastellatedMeshControls.Add("allowFreeStandingZoneFaces", m_Settings.AllowFreeStandingZoneFaces);
        }
        ...
        private void InitRefinementSurfaces()
        {
            ...
            m_StlRefinement.Add(level, m_Settings.WallLevel);
        ...
        private void InitRegionsRefinement()
        {
            ...
            foreach (var face in m_Faces)
            {
                ...
                {
                    vec = m_Settings.InletLevel;
                }
                else if (name.Contains("Outlet") || name.Contains("Abluft"))
                {
                    vec = m_Settings.OutletLevel;
                }
